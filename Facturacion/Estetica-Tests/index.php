...
$title = "Salón de Estética Joana - Página Principal";
        ...
        <div class="col-md-1"></div>
            <div class="col-md-10">
                <div id="view1">
                    ...
                    <div class="mask" style="background-color: rgba(0, 0, 0, 0.6);">
                        <div class="d-flex justify-content-center align-items-center h-100"></div>
                            <div class="text-white">
                                    <h1 class="mb-3">Joanna - Salón de Estética</h1>
                            </div>
                    </div>
                    <div id="slide" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="img/botox.jpg" class="d-block w-100" alt="botox" width="960px" height="600px">
                            </div>
                            <div class="carousel-item">
                                <img src="img/facial.jpg" class="d-block w-100" alt="facial" width="960px" height="600px">
                            </div>
                            <div class="carousel-item">
                                <img src="img/depilacion.jpg" class="d-block w-100" alt="depilacion" width="960px" height="600px">
                            </div>
                            <div class="carousel-item">
                                <img src="img/axilas.jpg" class="d-block w-100" alt="axilas" width="960px" height="600px">
                            </div>
                            <div class="carousel-item">
                                <img src="img/lips.jpg" class="d-block w-100" alt="lips" width="960px" height="600px">
                            </div>
                            <div class="carousel-item">
                                <img src="img/pubis.jpg" class="d-block w-100" alt="pubis" width="960px" height="600px">
                            </div>
                        </div>
                    ...
                    <h3>Todos los Tratamientos de Belleza al Mejor Precio.</h3>
                    <br>
                </div>
                <div id="view2">
                    <div class="col-md-7">
                        <br><br><br><br>
                        <h2>Nuestros Precios son los Mejores del Mercado</h2>
                        <br>
                        ...
                        <?php
                            $i = 0;
                            $ok = false;
                            $sql = "SELECT service, price, img FROM services";
                            ...
                            {
                                echo "<script>toast(1, 'No hay nada aun:', 'Estamos Montando la Tienda Online, Pronto Podrás Hacer tus Pedidos a Domicilio.')</script>";
                            }
                            if ($ok)
                            {
                        ...
                        <br>
                        <h4>Puedes Registrarte y Solicitar tu Cita Online.</h4>
                    </div>
                </div>
                <div id="view3">
                    <div class="row">
                        <div class="col-md-7">
                        <br><br><br>
                            <h2>Te Damos la Bienvenida a la WEB del Salón de Estética de Joana</h2>
                            <br>
                        ...
                        <div class="col-md-5">
                            ...
                            <h3>Entrada de Clientes para Solicitar Cita</h3>
                            <br>
