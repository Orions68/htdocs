...
$title = "Inspi - Recupera tu Contraseña";
...
if (isset($_POST["email"]))
{
    ...
    $ok = false;
    $sql = "SELECT email FROM client;"; // Preparo una consulta de todos los E-mail de espectadores de la base de datos.
    ...
    {
        echo "<script>toast(2, 'Hay un Error', 'Lo Siento no Existe Ningún Espectador con E-mail: $email, Vuelve a Intentarlo con la Dirección con la que te Registrate.');</script>"; // Error.
    }
