<?php
$title = "Página de Contacto - Obras y Reformas Fernando"; // Pagina de contacto, con un formulario para seleccionar la forma de contacto.
...
<section class='container-fluid pt-3'>
    <div class='row'>
        <div class='col-sm-1'></div>
            <div class='col-sm-10'>
                <div id='view1' style="margin-bottom: 5%;">
                    <br><br><br>
                    <h1>Página de Contacto Obras y Reformas Fernando</h1>
                    <br>
                    <h3>Selecciona la Forma de Contacto, Nosotros nos Pondremos en Contacto Contigo</h3>
                    <br>
                    <h4>También puedes escribirnos a: <small><a href="mailto:felipedenecochea@gmail.com">Fernando Filippelli</a></small></h4>
                    <h3>O <img src="img/fernando.png" alt="Whatsapp" width="240"> WhatsApp</h3>
                    <br><br>
