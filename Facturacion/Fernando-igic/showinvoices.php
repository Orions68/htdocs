                ...
                for ($j = 0; $j < $i; $j++)
                {
					echo '<div id="printable' . $j . '">
                        ...
                        <div style="width: 1px;"></div>
                            ...
                            <div class="column middle" style="background-color:#d8d8d8;">' . $material[$j] . '
                            </div>
                            <div class="column right" style="background-color:#dfdfdf;">' . number_format((float)$price[$j], 2, ',', '.') . ' €
                            </div>
                            <div class="column oneright" style="background-color:#e0e0e0;">' . number_format((float)$hand[$j], 2, ',', '.') . ' €
                            </div>
                            <div class="column moreright" style="background-color:#e8e8e8;">' . number_format((float)$total[$j], 2, ',', '.') . ' €
                            </div>
                            <div class="column moreright" style="background-color:#efefef; text-align:center;">Exento
                            </div>
                            <div class="column final" style="background-color:#fefefe; text-align:right;">' . number_format((float)$totaligic[$j], 2, ',', '.') . ' €</div>
                        </div>
                        <div class="row">
