<nav class="navbar fixed-top bg-white" id="pc">
    <div class="col-md-8"> <!-- Columnas con el menú de navegación. -->
      <div class="nav nav-tabs" id="nav-tab" role="tablist" >
          ...
          <a class="nav-link" aria-current="page" href="profile.php#view1" aria-selected="false" role="tab" aria-controls="nav-contact">Perfil</a>
          <a class="nav-link" aria-current="page" href="index.php#view2" aria-selected="false" role="tab" aria-controls="nav-contact">Busqueda de Productos</a>
