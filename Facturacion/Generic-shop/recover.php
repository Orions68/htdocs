...
$title = "XXXXX - Recupera tu Contraseña";
...
if (isset($_POST["email"]))
{
    ...
    else // Si el E-mail está en la base de datos.
    {
        ...
        $stmt = $conn->prepare($sql);
        $stmt->execute();
        echo "<script>toast(0, 'Todo ha Ido Bien', 'Se ha cambiado tu Contraseña a: $hash, Selecciónala y Cópiala, Después Vuelve a Iniciar Sesión con los Nuevos Datos. Te Recomendamos que Cambies la Contraseña, Gracias por Comprar Aquí.');</script>";
    }
}
?>
