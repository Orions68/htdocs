...
if (isset($_POST["id0"])) // Si se recibió al menos una compra.
{
    ...
    for ($i = 0; $i < $size; $i++) // Hago un bulce hasta el tamaño de los datos recibidos.
    {
        ...
        $total[$i] = $price[$i] * $qtty[$i]; // Calculo el total a pagar mutiplicando la cantidad de artículos comprados por el precio.
    }
}
else
{
...
$title = "Por Fin Tengo Mis Artículos"; // Título de la página.
