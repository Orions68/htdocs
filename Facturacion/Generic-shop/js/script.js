...
function printIt(form) // Función para imprimir la pantalla con la factura.
{
	form.submit();
	var prtContent = document.getElementById("printable");
	var WinPrint = window.open('', '', '');
	WinPrint.document.write('<!DOCTYPE html><html lang="es"><head><meta charset="UTF-8"><title>Imprimiendo Factura</title>');
