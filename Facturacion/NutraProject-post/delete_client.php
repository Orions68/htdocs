                ...
                <div class="col-md-1"></div>
                    <div class="col-md-10">
                        <div id="view1">
                            <br><br><br><br>
        <?php
        echo "<script>toast(2, 'Se Ha Eliminado Tu Perfil', 'Gracias por Haber Sido Parte de Nutra Project.');</script>";
    }
}
...
?>
<br><br>
					<input type="button" value="Cierra Esta Ventana" onclick="window.open('index.php', '_self')">
				</div>
            </div>
        <div class="col-md-1"></div>
    </div>
