        ...
        <div class='col-sm-1'></div>
            <div class='col-sm-10'>
                <div id="page_top">
                    ...
                    <h2>Descarga los QR y guardalos en lugar seguro, si lo prefieres podrás imprimirlos y presentarlos en papel a la entrada al evento.</h2>
                    <h3>Todas tus entradas estarán disponibles en tu perfil de ususario. Solo para los usuarios registrados.</h3>
                    <h4><span style="color: red">IMPORTANTE:</span>Al obtener todas las entradas presiona el botón Ahora Sí</h4>
                    ...
                    for ($i = 0; $i < $size; $i++)
                    {
                        ...
                        {
                            $good_url = urlencode('http://ticketes.atspace.eu/server.php?client=' . $id_esp . '&id=' . $id[$i] . '&title=' . $event[$i] . '&qtty='. $qtty[$i] . "&seats=" . $seats[$i]);
                        ...
                        {
                            $good_url = urlencode('http://ticketes.atspace.eu/server.php?client=0&id=' . $id[$i] . '&title=' . $event[$i] . '&qtty='. $qtty[$i] . "&seats=" . $seats[$i]);
                        }
                        ...
                        echo "<a id='link" . $i . "' target='_blank' download><img id='img" . $i . "' width='240' heigth='160'>Descarga el Código y Guárdalo para Mostrarlo a la Entrada al Evento.</a>";
                        echo "<br><br>";
                    ...
                    echo '<input class="btn btn-primary" style="width: 240px; height: 120px;" type="submit" id="btn" style="visibility: hidden;" value="Ahora Sí">';
