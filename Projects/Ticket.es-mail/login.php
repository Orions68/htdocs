...
include "includes/modal-esp.html";
...
$ok = false;
    if (isset($_POST["email"])) // Verifico si llegan datos por post.
    {
        ...
        $ok = show($conn, $sql, $pass, "viewer"); // Asigno el resultado de la función show() a la variable $ok, a show le paso la conexion, la consulta y la contraseña.
    }
